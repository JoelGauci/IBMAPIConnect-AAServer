...
router.get('/', function(req, res, next) {
  ...
  res.render('loginAccount', {original_url: original_url, app_name: app_name, brand: brand, context: context, channel: channel, state: state, scope: scope, clientid: clientid});
});
